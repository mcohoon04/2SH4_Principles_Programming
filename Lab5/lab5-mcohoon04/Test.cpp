...
void testAdd5() {
    ...
    SLLSet listObj2 =  SLLSet(arr,0);
        ...
        int addfirst = 1;  // test add first node
...
void testIntersection5() {
    ...
    int inter3[] = {1, 2, 3, 7, 8}; //test intersection

    SLLSet listObj15 = SLLSet(inter3,5);
    SLLSet listObj16 = listObj2.intersection(listObj15);
...
bool runAllTests(int argc, char const *argv[]) {
	...
	s.push_back(CUTE(testSLLSetEmptyIntArray));
	s.push_back(CUTE(testCopyEmpty));
	s.push_back(CUTE(testIsInFalseEmpty));
