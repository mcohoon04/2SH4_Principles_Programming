...
*/
    ...
    void TestQ3_Border_1(CuTest *tc) {
    ...
    void TestQ3_Border_2(CuTest *tc) {
...
//=================Question 7================================  
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ2_nonInt);
        ...
        SUITE_ADD_TEST(suite, TestQ3_Border_1);
        SUITE_ADD_TEST(suite, TestQ3_Border_2);
        ...
        SUITE_ADD_TEST(suite, TestQ4_Border);
